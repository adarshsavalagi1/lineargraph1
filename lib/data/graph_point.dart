...
List<Graphpoint> newSetData = [
  ...
  // Graphpoint(20, 40, 25, 7),
  // Graphpoint(15, 25, 20, 8),
  Graphpoint(35, 45, 230, 9),
  // Graphpoint(25, 35, 30, 10),
  // Graphpoint(40, 50, 45, 11),
  Graphpoint(45, 55, 20, 12),
  // Graphpoint(30, 40, 35, 13),
  // Graphpoint(20, 130, 25, 14),
  // Graphpoint(10, 20, 15, 15),
  // Graphpoint(5, 15, 10, 16),
...
List<Graphpoint> staticGraph = [
  Graphpoint(25, 91, 0, 2),
  Graphpoint(15, 95, 60, 3),
  Graphpoint(56, 101, 70, 4),
  Graphpoint(94, 103, 98, 5),
  Graphpoint(35, 45, 40, 6),
  Graphpoint(40, 101, 50, 7),
  Graphpoint(94, 98, 0, 8),
  Graphpoint(23, 101, 98, 9),
  Graphpoint(94, 98, 98, 10),
  Graphpoint(91, 101, 98, 11),
  Graphpoint(94, 101, 98, 12),
  Graphpoint(5, 89, 80, 13),
];


List<Graphpoint> spotData=[
  Graphpoint(29, 92, 53, 0),
  Graphpoint(20, 90, 50, 1),
  Graphpoint(25, 85, 55, 2),
  Graphpoint(15, 75, 40, 3),
